    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("KYN-light"), QVariant("light"));
    ui->theme->addItem(QString("KYN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("KYN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("KYN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("KYN-traditional"), QVariant("trad"));
