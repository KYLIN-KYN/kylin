    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("KYLIN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a KYLIN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and KYLIN: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About KYLIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about KYLIN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for KYLIN Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your KYLIN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified KYLIN addresses"));
    ...
    openAction->setStatusTip(tr("Open a KYLIN: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the KYLIN Core help message to get a list with possible KYLIN Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("KYLIN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to KYLIN network", "", count));
    } else {
...
{
    QString strTitle = tr("KYLIN Core"); // default title
