    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("KYLIN Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About KYLIN Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  KYLIN-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the KYLIN in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 KYN, 0.1 KYN, 1 KYN and 10 KYN -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("KYLIN Core is shutting down...") + "<br /><br />" +
