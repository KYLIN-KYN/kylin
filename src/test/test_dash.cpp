...
#define BOOST_TEST_MODULE KYLIN Test Suite

#include "test_KYLIN.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_KYLIN_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
