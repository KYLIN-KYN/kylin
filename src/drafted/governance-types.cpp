...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "KYLINNetwork") type = KYLINNetwork;
    if(strType == "KYLINNetworkVariable") type = KYLINNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == KYLINNetwork) s = "KYLINNetwork";
    if(type == KYLINNetworkVariable) s = "KYLINNetworkVariable";
