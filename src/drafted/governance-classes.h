 ...
 *
 *   // network
 *   CKYLINNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.KYLIN.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CKYLINNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: KYLINNetwork
// //   -- signature requirements : Key1(User)
// class CKYLINNetworkVariable : public CGovernanceObject
// {
// private:
